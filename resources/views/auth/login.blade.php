    ...
    <div class="w-1/2 m-auto mt-10 shadow-lg rounded-lg p-4 dark:bg-gray-800 ">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1 w-full dark:text-gray-950" type="email" name="email" :value="old('email')"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full dark:text-gray-950" type="password" name="password" required
